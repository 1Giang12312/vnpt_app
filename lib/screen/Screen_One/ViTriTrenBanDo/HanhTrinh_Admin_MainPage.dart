...
class HanhTrinh_Admin_MainPage extends StatefulWidget {
  @override
  _HanhTrinh_Admin_MainPageState createState() => _HanhTrinh_Admin_MainPageState();
}

class _HanhTrinh_Admin_MainPageState extends State<HanhTrinh_Admin_MainPage> {
...
Future<void> loadDS_NV_SoKM() async {
    ...
    if (startDateController.text.isEmpty ||
      ...
      try {
        dataList = await HanhTrinh_Logic.LoadDS_NV_SoKM(
          startDateController.text,
          endDateController.text
        );
        setState(() {
      ...
      body: Padding(
        ...
        child: Column(
          children: [
            ...
            // Nút tìm kiếm
            ElevatedButton(onPressed: loadDS_NV_SoKM, child: Text("Tìm kiếm")),
            // // Danh sách kết quả
            // Expanded(
            //   child: FlutterMap(
               ...
               dataList.isEmpty
                  ...
                  : ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return Card(
                          child: ListTile(
                            title: Text("Nhân viên: ${item.user_one}"),
                            subtitle: Text("Số KM đã đi: ${item.total_distance_km} km"),
                            trailing: ElevatedButton(
                              onPressed: () {
                                pageTrasition(context,HanhTrinh_Detail_MainPage(user_one: item.user_one,ngay_bd: startDateController.text,ngay_kt:  endDateController.text));
